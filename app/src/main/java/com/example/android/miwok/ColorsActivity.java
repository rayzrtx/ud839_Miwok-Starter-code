...
public class ColorsActivity extends AppCompatActivity {
    ...
    private AudioManager.OnAudioFocusChangeListener mOnAudioFocusChangeListener = new AudioManager.OnAudioFocusChangeListener() {
        ...
        public void onAudioFocusChange(int focusChange) {
            if (focusChange == AudioManager.AUDIOFOCUS_LOSS_TRANSIENT ||
                ...
                //PAUSE PLAYBACK and reset to play file from the beginning
                mMediaPlayer.pause();
                mMediaPlayer.seekTo(0);
            } else if (focusChange == AudioManager.AUDIOFOCUS_GAIN){
                //We have regained audio focus so Resume Playback
                mMediaPlayer.start();
            } else if (focusChange == AudioManager.AUDIOFOCUS_LOSS){
                //We've lost audio focus so we should stop playback and cleanup resources
                releaseMediaPlayer();
            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Create an ArrayList of words to display when Colors category is clicked
    ...
    protected void onStop() {
        //Whenever we override an activity life cycle method, we need to call the super class version
        super.onStop();
